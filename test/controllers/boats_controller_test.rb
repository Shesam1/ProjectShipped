...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { assign_jobs: @boat.assign_jobs, company_id: @boat.company_id, max_load: @boat.max_load, name: @boat.name, photo: @boat.photo, size: @boat.size } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { assign_jobs: @boat.assign_jobs, company_id: @boat.company_id, max_load: @boat.max_load, name: @boat.name, photo: @boat.photo, size: @boat.size } }
